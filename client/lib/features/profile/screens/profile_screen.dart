...
class _ProfileScreenState extends State<ProfileScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              if (provider.hasWorkHours) ...[
                ...
                Text(
                  'Anda belum mengatur jam kerja harian.',
                  style: TextStyle(color: textSecondaryColor, fontSize: 14),
                ),
                const SizedBox(height: 20),
              ],
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    provider.hasWorkHours ? 'Ubah Jam Kerja' : 'Atur Jam Kerja',
  ...
  Future<void> _selectWorkHours(
    ...
    final start = await showTimePicker(
      context: context,
      initialTime: provider.workStart ?? const TimeOfDay(hour: 9, minute: 0),
    ...
    final end = await showTimePicker(
      context: context,
      initialTime: provider.workEnd ?? const TimeOfDay(hour: 17, minute: 0),
      helpText: 'Pilih Jam Selesai Kerja',
    );

    if (end == null) return;

    provider.setWorkHours(start, end);
