...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    super.initState();
    // Initialize controllers - will be populated in build with Provider data
  ...
  void _handleSave() async {
    if (_formKey.currentState!.validate()) {
      ...
      final bool isPasswordChange = _passwordController.text.isNotEmpty;
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          title: Text(
            isPasswordChange ? 'Konfirmasi Ubah Password' : 'Konfirmasi',
          ),
          content: Text(
            isPasswordChange
                ? 'Yakin ingin mengubah password? Pastikan Anda mengingat password baru.'
                : 'Yakin ingin menyimpan perubahan profil?',
          ),
          icon: isPasswordChange
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: isPasswordChange
                    ? Colors.orange
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ProfileProvider>(
      builder: (context, profileProvider, child) {
        // Update controllers with actual data if they're empty
        if (_usernameController.text.isEmpty &&
            profileProvider.username.isNotEmpty) {
          _usernameController.text = profileProvider.username;
        }
        if (_gmailController.text.isEmpty && profileProvider.gmail.isNotEmpty) {
          _gmailController.text = profileProvider.gmail;
        }
