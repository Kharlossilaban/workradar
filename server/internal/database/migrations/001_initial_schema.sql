-- Workradar Database Schema
-- MySQL Database
-- Updated sesuai dengan fitur frontend Flutter
...
-- DEFAULT DATA
-- ========================================
-- Default categories akan dibuat otomatis saat user register
-- Kerja, Pribadi, Wishlist, Hari Ulang Tahun
